package com.great.kindergarten.teacher.annotation;
...
@Aspect
@Component
public class TeacherSystemLogAspect {
//注入Service用于把日志保存数据库
...
//    private UserService userService;
    ...
    @Pointcut("within(com.great.kindergarten.teacher.controller.*) && @annotation(com.great.kindergarten.teacher.annotation.TeacherSystemLog)")
            ...
            for (Method method : methods) {
                if (method.getName().equals(methodName)) {
                    ...
                    if (clazzs.length == arguments.length) {
                        operationType = method.getAnnotation(TeacherSystemLog.class).operationType();
                        operationName = method.getAnnotation(TeacherSystemLog.class).operationName();
                        break;
                    }
                }
            }
